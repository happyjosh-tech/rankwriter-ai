...
<div class="wrap rwai-wrap">
	...
	<form method="post" class="rwai-form">
		...
		<table class="form-table" role="presentation">
			...
			<tr>
				<th scope="row"><label for="rwai_humanize"><?php esc_html_e( 'Polish for human voice', 'rankwriter-ai' ); ?></label></th>
				<td>
					...
					<p class="description"><?php esc_html_e( 'Strongly recommended. Roughly doubles the per-article API cost but dramatically reduces the "AI-written" feel. The pass preserves every fact, number, HTML tag, and internal link in the draft — it only rewrites prose.', 'rankwriter-ai' ); ?></p>
				</td>
			</tr>
			<tr>
